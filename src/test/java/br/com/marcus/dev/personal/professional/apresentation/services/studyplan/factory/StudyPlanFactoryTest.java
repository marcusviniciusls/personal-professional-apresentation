...
@SpringBootTest
public class StudyPlanFactoryTest {
    ...
    @Test
    @Transactional
    @DisplayName("Converter Entidade em Resposta (StudyPlan)")
    public void convertEntityInResponseTest(){
        ...
        StudyPlanResponse response = studyPlanFactory.convertEntityInResponse(studyPlan);
    ...
    @Test
    @Transactional
    @DisplayName("Converter SaveForm em Entidade (StudyPlan)")
    public void convertSaveFormInEntityTest(){
        ...
        // Executando método
        studyPlan = studyPlanFactory.convertSaveFormInEntity(studyPlanSaveForm);

        // Testes Unitários
        Assertions.assertTrue(studyPlan != null);
        Assertions.assertEquals("studyPlan", studyPlan.getName());
        Assertions.assertEquals(Level.BASIC, studyPlan.getLevel());
        Assertions.assertEquals("Java", studyPlan.getLanguageProgrammer().getName());
        Assertions.assertEquals("", studyPlan.getLanguageProgrammer().getDescription());
        Assertions.assertEquals("Spring", studyPlan.getFramework().getName());
        Assertions.assertEquals("description", studyPlan.getFramework().getDescription());
        Assertions.assertEquals(2, studyPlan.getListCertificate().size());
        Assertions.assertEquals(1, studyPlan.getListGraduation().size());
        Assertions.assertEquals(2, studyPlan.getListAssignments().size());
        Assertions.assertEquals(1, studyPlan.getListProfessionalExperience().size());
        Assertions.assertEquals(1, studyPlan.getListCourse().size());
    }
}
