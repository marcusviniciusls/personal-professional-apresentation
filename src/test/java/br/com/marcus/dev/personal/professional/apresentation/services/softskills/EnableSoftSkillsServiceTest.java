...
import br.com.marcus.dev.personal.professional.apresentation.services.softskils.EnableSoftSkillsService;
...
@SpringBootTest
public class EnableSoftSkillsServiceTest {
    ...
    public void setupInit(){
        ...
        SoftSkills softSkills = new SoftSkills("Boa comunicacao", false);
        softSkills.setId(id);
    ...
    @Test
    @Transactional
    @DisplayName("Habilitar SoftSkills")
    public void disableTest(){
        ...
        Assertions.assertTrue(softSkills.isStatusHas());
    }
}
