...
@SpringBootTest
public class FindByIdEntityStudyPlanServiceTest {

    @Autowired private StudyPlanRepository studyPlanRepository;
    @Autowired private FindByIdEntityStudyPlanService findByIdEntityStudyPlanService;
    ...
    public void findByIdTest(){
        // Executando método
        UUID id = UUID.fromString("cb260da4-01fb-48f0-aec4-d7f9db2ff371");
        StudyPlanResponse response = findByIdEntityStudyPlanService.findById(id);
        // Testes Unitários
    ...
    public void findByIdStatusFalseTest(){
        ...
        // Teste Unitário
        Assertions.assertThrows(ResourceNotFoundException.class, () -> findByIdEntityStudyPlanService.findById(id));
    }
