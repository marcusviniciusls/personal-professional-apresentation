...
@SpringBootTest
public class SaveProjectServiceTest {
    ...
    public void setupInit(){
        ...
        // Dados Mockados
        BDDMockito.given(centerEntityService.setDataToSave(Mockito.any(SuperEntity.class))).willReturn(project);
    }

    @Test
    @Transactional
    @DisplayName("Salvar Project")
    public void saveTest(){
        ...
        ProjectResponse response = saveProjectService.save(projectSaveForm);
